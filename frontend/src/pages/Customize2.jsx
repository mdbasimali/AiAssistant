...
const Customize2 = () => {
  ...
  return (
    <div
      className="w-full h-[100vh] bg-gradient-to-t 
    from-[black] to-[#020236] flex justify-center 
    items-center flex-col p-[20px] gap-[20px] relative"
    >
      ...
      <h1 className="text-white mb-[10px] text-[30px] text-center">
      ...
      <input
        ...
        className="w-full 
          h-[60px] max-w-[600px] outline-none border-2 border-white bg-transparent
      ...
      />
      {assistantName && <button className="min-w-[300px] h-[60px] bg-white rounded-full
      text-black font-semibold text-[19px] cursor-pointer"disabled={loading} onClick={()=>{
