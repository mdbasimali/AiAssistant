...
import bg from "../assets/VenomAuthBgImg.jpg";
...
const SignIn = () => {
  ...
  return (
    ...
    >
      <form
        className="w-[90%] h-[600px] max-w-[500px] bg-[#00000069]
       backdrop-blur shadow-lg shadow-blue-800 flex flex-col items-center
      ...
      >
        ...
        <div className="w-full h-[60px] border-2 border-white bg-transparent text-white rounded-full text-[18px] relative">
          ...
          {!showPassword &&  <IoEye onClick={()=>setShowPassword(true)} className="absolute top-[18px] right-[20px] 
          w-[25px] h-[25px] text-white cursor-pointer" />}

          {showPassword &&  <IoEyeOff onClick={()=>setShowPassword(false)} className="absolute top-[18px] right-[20px] 
          w-[25px] h-[25px] text-white cursor-pointer" />}
